...
const AdminSocialTrading = lazy(() => import("./pages/admin/AdminSocialTrading"));
         ...
         <BrowserRouter>
           ...
           <SafeAppwriteProvider>
             <Routes>
                        ...
                        <Route path="/traders/:username" element={withTradingRoute(<TraderProfile />)} />
                        ...
                        <Route path="/admin" element={withProtectedRoute(<AdminLayout />)}>
                          ...
                          <Route path="social" element={withRouteSuspense(<AdminSocialTrading />)} />
