...
const DETAIL_KEYWORDS =
  "trading tournament, online trading competition, demo balance challenge, trading prize pool, weekly trading tournament";
...
export const buildTournamentListingSeo = (platformName: string): RouteSeoOverride => ({
  ...
  metaKeywords:
    "trading tournaments, weekly trading tournaments with prizes, online trading competition, real prize tournaments, free trading tournament",
