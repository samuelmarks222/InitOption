...
const shortcutClassName =
  "group relative flex h-[60px] w-[58px] flex-col items-center justify-center overflow-hidden rounded-[17px] border px-2 py-[7px] text-center transition-transform duration-200 hover:-translate-y-[1px] active:scale-[0.98]";

const shortcutStyle: CSSProperties = {
  background:
    "linear-gradient(180deg, #34394a 0%, #2f3445 54%, color-mix(in srgb, #34394a 70%, var(--trading-sidebar-bg)) 100%)",
  borderColor: "rgba(149, 160, 188, 0.28)",
  boxShadow: "0 14px 26px rgba(5, 10, 22, 0.26), inset 0 1px 0 rgba(255,255,255,0.12)",
  color: "#ffffff",
};
...
const TradeDeskContent = () => (
  <>
    <span
      ...
      style={{
        background:
          "radial-gradient(circle at 22% 0%, rgba(255,255,255,0.16), transparent 31%), radial-gradient(circle at 80% 86%, rgba(8,12,24,0.34), transparent 44%)",
      }}
    />
    <span
      className="relative flex h-[29px] w-[36px] items-center justify-center overflow-hidden rounded-[11px] border"
      style={{
