...
const HISTORY_DATA = [
  ...
  { time: "17:20", date: "24 Feb", pair: "EUR/JPY", type: "4 Trade",  amount: 8000,  profit: 57120, pct: "+89%",    isUp: true },
  { time: "16:12", date: "23 Feb", pair: "EUR/JPY", type: "2 Trade",  amount: 4000,  profit: 3560,  pct: "+89%",    isUp: true },
  { time: "22:00", date: "20 Feb", pair: "SOL/USD", type: "Trade",     amount: 100,   profit: 89,    pct: "+89%",    isUp: true },
  { time: "18:26", date: "20 Feb", pair: "EUR/JPY", type: "2 Trade",  amount: 2000,  profit: 1780,  pct: "+89%",    isUp: true },
  { time: "18:22", date: "20 Feb", pair: "EUR/JPY", type: "2 Trade",  amount: 2000,  profit: -2000, pct: "-100%",   isUp: false },
  { time: "18:20", date: "20 Feb", pair: "EUR/JPY", type: "2 Trade",  amount: 2000,  profit: 1780,  pct: "+89%",    isUp: true },
  { time: "18:19", date: "20 Feb", pair: "EUR/JPY", type: "2 Trade",  amount: 2000,  profit: -2000, pct: "-100%",   isUp: false },
  { time: "18:18", date: "20 Feb", pair: "EUR/JPY", type: "Trade",     amount: 100,   profit: 89,    pct: "+89%",    isUp: true },
  { time: "18:17", date: "20 Feb", pair: "EUR/JPY", type: "2 Trade",  amount: 200,   profit: 178,   pct: "+89%",    isUp: true },
];

// ─── Tutorials Data ────────────────────────────────────────────────────────────
const TUTORIALS = [
  { id: "how", icon: "❓", title: "How to trade?", sub: "Trading Guide" },
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="px-3 py-2 border-b flex items-center gap-2" style={{ borderColor: "hsl(228 15% 14%)" }}>
        ...
        <span className="text-[11px] text-[#0fa053] font-medium flex-1">Adrian P.</span>
