import { Gift, Users, Wallet, ArrowRight, X } from "lucide-react";
...
const WelcomeGuideModal = ({ onClose, onDeposit, onReferral }: WelcomeGuideModalProps) => {
  return (
        ...
        <div className="relative px-4 pb-5 pt-6 sm:px-6 sm:pb-8 sm:pt-8">
          ...
          <div className="mt-5 space-y-3 sm:mt-6 sm:space-y-3.5">
            ...
            >
              ...
              <div>
                <p className="text-[13px] font-semibold text-white sm:text-[14px]">Deposit funds</p>
