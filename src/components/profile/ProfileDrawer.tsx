...
export const ProfileDrawer = ({ isOpen, onClose, balance, initialTab = "personal" }: ProfileDrawerProps) => {
  ...
  }, [balance, markStepCompleted, profile, user?.email]);
              ...
              <div className="min-w-0">
                ...
                <div className="mt-3 flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-[13px] text-[#96a3bb]">
            ...
            <div className="mt-5 flex gap-2 overflow-x-auto pb-1">
              {TAB_ITEMS.map((item) => (
                <button
                  ...
                  className={`shrink-0 rounded-[12px] px-4 py-3 text-[14px] font-bold transition-colors ${
                    activeTab === item.id
