...
const FloatingBill = ({ className }: { className?: string }) => (
  ...
  >
    <div className="flex h-full items-center justify-between rounded-lg border border-white/20 bg-[linear-gradient(180deg,hsla(var(--landing-surface),0.2)_0%,hsla(var(--landing-surface),0.08)_100%)] px-2">
      <span className="text-lg font-black text-[hsl(var(--landing-secondary))]/80">$</span>
      <div className="space-y-1">
        <div className="h-1.5 w-6 rounded-full bg-[hsl(var(--landing-secondary))]/40" />
        <div className="h-1.5 w-4 rounded-full bg-[hsl(var(--landing-secondary))]/25" />
      </div>
    </div>
  </div>
);
...
const PromoIllustration = () => (
  <div className="relative mx-auto h-[222px] w-full max-w-[330px] sm:h-[248px]">
    ...
    <div className="absolute bottom-[18px] left-[22%] h-24 w-[104px] rotate-[18deg] rounded-[34px] bg-[linear-gradient(180deg,#ffffff_0%,white_100%)] shadow-[0_16px_32px_hsla(var(--landing-secondary),0.08)]">
      <div className="absolute -left-8 bottom-0 h-20 w-16 rounded-[28px] bg-[linear-gradient(180deg,white_0%,hsl(var(--landing-surface))_100%)]" />
      <div className="absolute left-3 top-3 h-14 w-12 rounded-[22px] bg-[linear-gradient(180deg,#ffffff_0%,white_100%)]" />
      <div className="absolute -bottom-2 right-2 h-9 w-24 rounded-[28px] bg-[linear-gradient(180deg,#ffffff_0%,white_100%)]" />
      <div className="absolute -right-5 bottom-8 h-14 w-14 rounded-full bg-[linear-gradient(180deg,#ffffff_0%,white_100%)]" />
      <div className="absolute -bottom-3 left-6 h-16 w-20 rounded-[30px] bg-[linear-gradient(180deg,white_0%,hsl(var(--landing-surface))_100%)] shadow-[0_10px_14px_hsla(var(--landing-secondary),0.06)]" />
    </div>

    <div className="absolute left-1/2 top-[40px] flex h-[144px] w-[98px] -translate-x-1/2 flex-col rounded-[22px] border-[4px] border-[hsl(var(--landing-border))] bg-white px-3 pb-3 pt-3 shadow-[0_18px_32px_hsla(var(--landing-secondary),0.08)]">
      <div className="mx-auto mb-2 h-1.5 w-12 rounded-full bg-[hsl(var(--landing-border))]" />
      <div className="mb-3 flex items-center gap-2">
        <div className="h-4 w-4 rounded-full bg-[hsl(var(--landing-primary))]" />
        <div className="h-1.5 w-6 rounded-full bg-[hsl(var(--landing-secondary))]/50" />
      </div>
      <div className="flex flex-1 items-end gap-1">
        <div className="h-9 w-1.5 rounded-full bg-[hsl(var(--landing-primary))]" />
        <div className="h-[3.25rem] w-1.5 rounded-full bg-[hsl(var(--landing-secondary))]/40" />
        <div className="h-8 w-1.5 rounded-full bg-[hsl(var(--landing-primary))]" />
        <div className="h-5 w-1.5 rounded-full bg-[hsl(var(--landing-secondary))]/40" />
        <div className="h-11 w-1.5 rounded-full bg-[hsl(var(--landing-primary))]" />
        <div className="h-7 w-1.5 rounded-full bg-[hsl(var(--landing-secondary))]/40" />
      </div>
      ...
      <div className="mt-auto space-y-1">
        ...
        <div className="ml-auto flex w-fit items-center rounded-full bg-[hsl(var(--landing-secondary))]/10 px-2 py-0.5 text-[8px] font-black uppercase tracking-[0.12em] text-[hsl(var(--landing-secondary))]">
          Sell
        </div>
      </div>
    </div>
...
const BenefitRow = ({
  ...
  return (
    <div className="flex items-start gap-4 text-left">
      <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl border border-[hsl(var(--landing-border))] bg-[hsl(var(--landing-surface))] text-[hsl(var(--landing-border))]">
        <Icon className="h-4.5 w-4.5" />
      </div>
      <p className="font-landing-copy text-[16px] leading-[1.25] text-[hsl(var(--landing-secondary))] sm:text-[18px]">{children}</p>
    </div>
  );
};
    ...
    <DialogPrimitive.Root open={open} onOpenChange={handleOpenChange}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className="fixed left-1/2 top-1/2 z-50 w-[min(92vw,620px)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[28px] border border-[hsl(var(--landing-border))] bg-white font-landing-copy text-[hsl(var(--landing-secondary))] shadow-[0_30px_100px_hsla(var(--landing-secondary),0.1)] outline-none data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
        >
          <div className="absolute inset-x-0 top-0 h-24 bg-[linear-gradient(180deg,hsla(var(--landing-primary),0.16)_0%,transparent_100%)]" />
          ...
          <DialogPrimitive.Close asChild>
            <button
              type="button"
              className="absolute right-4 top-4 z-10 rounded-full p-2 text-[hsl(var(--landing-border))] transition hover:bg-[hsl(var(--landing-surface))] hover:text-[hsl(var(--landing-secondary))]"
          ...
          <div className="relative px-4 pb-6 pt-5 sm:px-7 sm:pb-8 sm:pt-6">
            ...
            <div className="mx-auto mt-1 max-w-[500px]">
              <DialogPrimitive.Title className="text-center font-landing-display text-[26px] font-black leading-none text-[hsl(var(--landing-secondary))] sm:text-[36px]">
                Register right now!
