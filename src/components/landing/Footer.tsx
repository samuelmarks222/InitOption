        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-8 border-b border-white/8 pb-10 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-xl">
              ...
              />
              <p className="max-w-xl font-copy text-sm leading-7 text-white/76 sm:text-base">
                ...
                {(socialLinks.title?.trim() || socialLinks.subtitle?.trim()) ? (
                  <div className="mb-4 lg:text-right">
                    ...
                    {socialLinks.subtitle?.trim() ? (
                      <p className="mt-2 max-w-md font-copy text-sm leading-6 text-white/68 lg:ml-auto">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr_1.05fr_0.95fr_1.55fr]">
            {footerLinkGroups.map((group) => (
              <div key={group.title}>
                ...
                <ul className="mt-5 space-y-4 font-copy text-[15px] leading-7 text-white/82 sm:text-base">
            ...
            <div>
              ...
              <p className="mt-5 max-w-3xl font-copy text-[15px] leading-8 text-white/82 sm:text-base">
          ...
          <div className="border-t border-white/8 pt-6 text-center font-copy text-xs text-white/64 sm:text-sm">
