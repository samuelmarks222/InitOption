...
const Footer = ({ content }: FooterProps) => {
  ...
  return (
    <footer
      className="relative overflow-hidden border-t border-[#10b86b]/30 bg-[#212634] text-white"
      style={{
        backgroundImage:
    ...
    >
      <div
        aria-hidden="true"
        className="h-3 w-full border-y border-[#10b86b]/25 bg-[repeating-linear-gradient(135deg,#10b86b_0_5px,#0d9a7a_5px_10px)]"
      />
      <div
        aria-hidden="true"
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-14">
          <div className="lg:col-span-4">
            ...
            <a
              ...
              className="mt-7 inline-flex max-w-full items-center gap-4 rounded-sm border border-[#10b86b]/25 bg-white/[0.03] px-4 py-3 transition-colors hover:border-[#10b86b]/50 hover:bg-white/[0.06]"
            >
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#10b86b]/40 text-[#10b86b]">
              ...
              <span className="min-w-0">
                ...
                <span className="mt-0.5 block font-copy text-xs font-bold uppercase tracking-[0.12em] text-[#10b86b]">
                  Support 24/7
                </span>
              </span>
            </a>
            ...
            {visibleSocialLinks.length ? (
              <div className="mt-7 flex flex-wrap items-center gap-3">
                <span className="font-copy text-sm font-black text-[#10b86b]">Follow On :</span>
                ...
                {visibleSocialLinks.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/70 transition-all duration-200 hover:border-[#10b86b]/60 hover:bg-[#10b86b]/15 hover:text-[#10b86b]"
                    >
                      <Icon className={`h-4 w-4 ${isWhatsApp ? "text-[#10b86b]" : ""}`} strokeWidth={2.2} />
                    </a>
                  );
                })}
              </div>
          ...
          <div className="lg:col-span-5">
            ...
            <div className="mt-4 h-px w-full bg-white/10">
              <div className="h-px w-24 bg-[#10b86b]" />
            </div>
            ...
            <ul className="mt-8 grid gap-x-10 gap-y-4 sm:grid-cols-2">
              {footerLinkItems.map((item) => (
                <li key={`${item.label}-${item.to}`}>
                  ...
                  >
                    <ChevronRight className="h-4 w-4 text-[#10b86b] transition-transform group-hover:translate-x-1" />
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-4 h-px w-full bg-white/10">
              <div className="h-px w-20 bg-[#10b86b]" />
            </div>

            <div className="mt-8 border-l-2 border-[#10b86b]/80 bg-white/[0.03] px-5 py-5">
              <div className="flex items-center gap-2 font-copy text-sm font-black text-white">
                <ShieldCheck className="h-4 w-4 text-[#10b86b]" />
                Trading Risk
              </div>
              ...
              <Link
                to="/risk-disclaimer"
                className="mt-4 inline-flex font-copy text-sm font-bold text-[#10b86b] transition-colors hover:text-white"
              >
      ...
      <div className="relative border-t border-[#10b86b]/20 bg-[#1a1f2c]/90">
        <div
          aria-hidden="true"
          className="absolute inset-y-0 left-0 hidden w-[52%] bg-[#10b86b] lg:block"
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-5 px-6 py-6 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="ml-1 flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#10b86b]/80 bg-white/5 font-copy text-sm font-black text-white shadow-[0_0_0_8px_rgba(255,255,255,0.04)]">
              100%
            </div>
          </div>
        </div>
