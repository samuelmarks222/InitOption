      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
          ...
          >
            ...
            <p className="mt-4 text-base leading-7 text-[hsl(var(--landing-muted))] lg:text-lg">
              Adjust your account size and profit rate to see your estimated monthly returns.
            </p>
            <div className="mt-8 rounded-2xl border border-gray-200/60 bg-white p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)] sm:p-10">
              <div className="mb-7">
