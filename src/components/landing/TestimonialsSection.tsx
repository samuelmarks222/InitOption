...
const TestimonialsSection = () => {
  ...
  const showNext = () => {
    setActiveIndex((currentIndex) => (currentIndex === testimonials.length - 1 ? 0 : currentIndex + 1));
  };
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <motion.article
              ...
              className={cn(
                "relative min-h-[324px] overflow-hidden rounded bg-white shadow-[0_18px_46px_rgba(9,53,47,0.04)] transition duration-300",
