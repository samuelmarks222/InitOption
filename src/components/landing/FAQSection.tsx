  ...
  return (
    <section id="faq" className="relative overflow-hidden bg-[hsl(var(--landing-surface))] py-20 sm:py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        <div className="grid items-start gap-12 lg:grid-cols-[1.3fr_0.9fr] lg:gap-16">
          <div>
            <motion.div
            ...
            >
              ...
              <p className="mt-4 max-w-xl text-base leading-7 text-[hsl(var(--landing-muted))] sm:text-lg">{faq.subtitle}</p>
            </motion.div>
          ...
          >
            <div className="sticky top-24 overflow-hidden rounded-2xl border border-gray-200/60 shadow-[0_8px_30px_rgba(0,0,0,0.06)]">
              <img
