  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-4">
        <h1 className="text-3xl font-bold text-white">Choose Withdrawal Method</h1>
        <p className="mt-2 text-white/60">Select how you'd like to receive your funds</p>
      </div>
