...
describe("platform metadata", () => {
  ...
  it("applies head tags, branding state, and custom meta tags", () => {
    applyPlatformSettingsToDocument(
      {
        ...
        meta_description: "Trade binary options with a demo balance and live OTC market access.",
    ...
    expect(document.title).toBe("Init Option - Binary Options Trading");
    expect(document.querySelector('meta[name="description"]')?.getAttribute("content")).toBe(
      "Trade binary options with a demo balance and live OTC market access.",
    );
