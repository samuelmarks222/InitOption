  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-[#1a1e2b] border border-[#2a2f42] rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-center space-y-4 hover:border-[#0fa053]/50 transition-colors cursor-pointer group">
        ...
        <div className="bg-[#1a1e2b] border border-[#2a2f42] rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-center space-y-4 hover:border-[#2a2f42]/50 transition-colors cursor-pointer group">
          <div className="w-12 h-12 rounded-full bg-[#1a1e2b]/10 text-[#8fb0cf] flex items-center justify-center group-hover:scale-110 transition-transform">
            <FileText size={24} />
          </div>
          <div>
        ...
        <div className="bg-[#1a1e2b] border border-[#2a2f42] rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-center space-y-4 hover:border-green-500/50 transition-colors cursor-pointer group">
        ...
        <div className="bg-[#1a1e2b] border border-[#2a2f42] rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-center space-y-4 hover:border-yellow-500/50 transition-colors cursor-pointer group">
      ...
      <div className="bg-[#1a1e2b] border border-[#2a2f42] rounded-2xl p-6 shadow-lg mt-8">
        <h3 className="text-lg font-bold text-white border-b border-[#2a2f42] pb-2 mb-6">Custom Report Builder</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Last 30 Days" className="w-full bg-[#0e1017] border border-[#2a2f42] rounded-lg pl-9 pr-4 py-2 text-sm text-white focus:border-[#0fa053] outline-none" readOnly />
            </div>
          </div>
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-300 uppercase tracking-wider">Primary Metric</label>
            <select className="w-full bg-[#0e1017] border border-[#2a2f42] rounded-lg px-4 py-2 text-sm text-white focus:border-[#0fa053] outline-none appearance-none">
          ...
          <div className="w-full">
            <button className="flex w-full items-center justify-center gap-2 bg-[#0fa053] hover:bg-[#1a1e2b] text-white px-4 py-2 rounded-lg text-sm font-bold transition-colors shadow-lg shadow-[#0fa053]/20">
