            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                {[
                  ...
                  <div
                    key={item.label}
                    className="rounded-[24px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] px-5 py-5 shadow-[0_18px_40px_rgba(0,0,0,0.06)]"
                  >
                    <div className="font-copy text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">
                      {item.label}
                    </div>
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-2">
              {isLoading ? (
                Array.from({ length: 4 }).map((_, index) => (
                  <div
                    key={index}
                    className="rounded-[28px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.06)]"
                  >
                    <div className="h-4 w-28 rounded-full bg-white/10" />
                    <div className="mt-5 h-8 w-3/4 rounded-full bg-white/10" />
                    <div className="mt-4 h-20 rounded-[20px] bg-white/5" />
                ...
                <div className="lg:col-span-2 rounded-[28px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] px-6 py-10 text-center shadow-[0_24px_60px_rgba(0,0,0,0.06)]">
                  <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-white/8 bg-white/5">
                ...
                visibleTournaments.map((tournament) => (
                  <article
                    key={tournament.id}
                    className="rounded-[28px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.06)] sm:p-8"
                  >
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      <div className="text-right">
                        <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Prize pool</div>
          ...
          <div className="mx-auto space-y-10 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              {[
                ...
                <article
                  key={event.title}
                    className="rounded-[26px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.06)]"
                  >
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      <div>
                        <h3 className="font-display text-2xl font-bold text-white">{event.title}</h3>
                        <p className="mt-3 text-sm leading-8 text-slate-400 sm:text-base">{event.details}</p>
                      </div>
                      <div className="min-w-[140px] rounded-[20px] border border-white/8 bg-black/20 px-4 py-4 text-right">
                        <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Prize pool</div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="rounded-[26px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.06)]">
                <h3 className="font-display text-2xl font-bold text-white">How to join a tournament</h3>
                <div className="mt-4 space-y-4 text-sm leading-8 text-slate-400 sm:text-base">
              ...
              <div className="rounded-[26px] border border-white/8 bg-gradient-to-br from-[#182435] to-[#0f1826] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.06)]">
                ...
                <div className="mt-4 grid gap-3">
                  {[
                    ...
                    <div key={rule} className="rounded-[18px] border border-white/8 bg-black/20 px-4 py-4 text-sm leading-7 text-slate-400">
                      {rule}
                    </div>
                  ))}
                </div>
