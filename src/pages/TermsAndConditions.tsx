    ...
    <div className="min-h-screen bg-background font-copy text-slate-300">
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <section className="bg-gray-900 rounded-lg p-8 space-y-6">
          ...
          <h2 className="font-display text-2xl font-bold text-white">2. Eligibility</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">3. Account Registration</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">4. Trading on InitOption</h2>
          <h3 className="font-display text-xl font-bold text-white">4.1 Binary Options</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">4.2 How Trades Work</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">4.3 Payout Rates</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">4.4 No Guarantees</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white">5. Deposits and Withdrawals</h2>
          <h3 className="font-display text-xl font-bold text-white">5.1 Deposits</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">5.2 Withdrawals</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">5.3 Fees</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">5.4 Refund Policy</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white">6. Demo Account</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">7. Bonuses and Promotions</h2>
          <h3 className="font-display text-xl font-bold text-white">7.1 Bonus Terms</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">7.2 Abuse and Prohibited Practices</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white">8. Platform Availability and Technical Issues</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">9. Prohibited Activities</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">10. Risk Disclosure</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">11. Intellectual Property</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">12. Limitation of Liability</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">13. Indemnification</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">14. Account Suspension and Termination</h2>
          <h3 className="font-display text-xl font-bold text-white">14.1 By Us</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">14.2 By You</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">14.3 Effect of Termination</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white">15. Privacy and Data Protection</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">16. Restricted Jurisdictions</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">17. Amendments to Terms</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">18. Governing Law and Dispute Resolution</h2>
          <h3 className="font-display text-xl font-bold text-white">18.1 Governing Law</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white">18.2 Dispute Resolution</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white">19. Contact Information</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">20. Acknowledgment</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white">21. Entire Agreement</h2>
          ...
          <p className="font-display text-xl font-bold text-white text-center mt-8">
