      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" variant="trading" className="w-full" size="lg" disabled={!agreed}>
              Create account
            </Button>
          </form>
        ...
        <p className="text-xs text-muted-foreground text-center mt-6 max-w-sm mx-auto">
          Trading involves risk. Your capital is at risk. CFDs are complex instruments and come with a high risk of losing money.
        </p>
      </div>
    </div>
  );
