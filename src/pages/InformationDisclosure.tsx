...
const InformationDisclosure = () => {
  return (
    <div className="min-h-screen bg-background font-copy text-slate-300">
      <Navbar />
      <main className="max-w-4xl mx-auto p-6">
        ...
        <section className="bg-gray-900 rounded-lg p-8 space-y-6">
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">TABLE OF CONTENTS</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">1. INTRODUCTION AND PURPOSE</h2>
          <p>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">2. SCOPE OF POLICY</h2>
          <p>This Policy applies to:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white w-32">Personal Information</td>
                ...
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Financial Information</td>
                  <td className="p-2">Transaction records, deposit and withdrawal history, trading activity, balances, payment method details</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Technical Information</td>
                  <td className="p-2">IP addresses, device identifiers, browser data, login timestamps, session data</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Communications</td>
                  <td className="p-2">Support tickets, live chat transcripts, email correspondence, feedback, survey responses</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">KYC and AML Data</td>
                  <td className="p-2">Identity documents, proof of address, source of funds information, verification status</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Account Information</td>
                  <td className="p-2">Usernames, passwords (hashed), security settings, two-factor authentication data</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Proprietary Information</td>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">3. TYPES OF INFORMATION COVERED</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">3.1 Confidential Information</h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white w-24">User personal data</td>
                  <td className="p-2">Name, email, phone number, address, date of birth</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">KYC documents</td>
                  <td className="p-2">Passport images, ID cards, utility bills, selfies</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Financial data</td>
                  <td className="p-2">Bank account details, crypto wallet addresses, transaction history</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Trading data</td>
                  <td className="p-2">Trade amounts, directions, expiry times, win/loss records</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Security data</td>
                  <td className="p-2">Password hashes, 2FA secrets, security question answers</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Internal data</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">3.2 Public Information</h3>
          <p>Public information is information that is intentionally made available to the general public. This includes:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white w-32">Marketing content</td>
                  <td className="p-2">Website copy, blog posts, social media content</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Public policies</td>
                  <td className="p-2">Terms and Conditions, Privacy Policy, AML Policy</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Public statements</td>
                  <td className="p-2">Press releases, official announcements</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Aggregated statistics</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">3.3 Anonymised Information</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">4. PRINCIPLES OF INFORMATION DISCLOSURE</h2>
          <p>We adhere to the following principles when disclosing information:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white w-28">Lawfulness</td>
                  <td className="p-2">Disclosure is only made when permitted or required by law</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Transparency</td>
                  <td className="p-2">Users are informed about how and why their information is disclosed</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Minimisation</td>
                  <td className="p-2">Only the minimum necessary information is disclosed for the specific purpose</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Accountability</td>
                  <td className="p-2">We document all disclosures and can justify them if questioned</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Security</td>
                  <td className="p-2">Information is disclosed using secure channels and methods</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Consent</td>
                  <td className="p-2">Where required, we obtain explicit user consent before disclosure</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Limited purpose</td>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">5. WHEN WE DISCLOSE INFORMATION</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">5.1 Disclosure with User Consent</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">5.2 Disclosure to Third-Party Service Providers</h3>
            ...
            <table className="w-full text-left text-sm border-collapse border border-slate-700">
              <thead>
                <tr className="bg-slate-800">
                  <th className="border-r border-slate-700 p-2">Provider Type</th>
                  <th className="border-r border-slate-700 p-2">Information Shared</th>
                  <th className="border-r border-slate-700 p-2">Purpose</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Payment processors (SasaPay, Plisio)</td>
                  <td className="border-r border-slate-700 p-2">Phone number, amount, transaction reference</td>
                  <td className="p-2">Process deposits and withdrawals</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">KYC verification providers (Sumsub, Onfido)</td>
                  <td className="border-r border-slate-700 p-2">ID documents, selfies, proof of address</td>
                  <td className="p-2">Verify user identity</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Cloud hosting (AWS, DigitalOcean)</td>
                  <td className="border-r border-slate-700 p-2">All platform data</td>
                  <td className="p-2">Store and process data</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2">Customer support software</td>
                  <td className="border-r border-slate-700 p-2">Support tickets, chat transcripts</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">5.3 Disclosure Required by Law</h3>
          <p>We may disclose information when required by applicable law, regulation, or legal process. This includes:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white w-28">Court orders</td>
                  <td className="p-2">Subpoena, search warrant, court judgment</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Regulatory requests</td>
                  <td className="p-2">Financial Reporting Centre (FRC) request, tax authority inquiry</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Law enforcement</td>
                  <td className="p-2">Police investigation, criminal proceeding</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Anti-money laundering</td>
                  <td className="p-2">Suspicious Activity Report (SAR) filing</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Tax reporting</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">5.4 Disclosure to Protect Legal Rights</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">5.5 Disclosure in Business Transfers</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">5.6 Disclosure for Security and Fraud Prevention</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">6. WHEN WE DO NOT DISCLOSE INFORMATION</h2>
          <p>We do <strong>not</strong> disclose information in the following circumstances:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">For marketing purposes</td>
                  <td className="p-2">We do not sell or rent user information to third parties for marketing</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">To unverified third parties</td>
                  <td className="p-2">We only share with verified, contractually bound providers</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">For non-specific purposes</td>
                  <td className="p-2">Disclosure requires a specific, stated purpose</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Beyond user consent</td>
                  <td className="p-2">We do not exceed the scope of consent given</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">To countries without adequate protection</td>
                  <td className="p-2">We ensure adequate safeguards for cross-border transfers</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">To circumvent legal requirements</td>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">7. DISCLOSURE TO GOVERNMENT AND REGULATORY AUTHORITIES</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">7.1 Kenya</h3>
          <p>We cooperate with Kenyan government and regulatory authorities, including:</p>
          <div className="overflow-x-auto mt-3">
            <table className="w-full text-left text-sm border-collapse border border-slate-700">
              <thead>
                <tr className="bg-slate-800">
                  <th className="border-r border-slate-700 p-2">Authority</th>
                  <th className="border-r border-slate-700 p-2">Jurisdiction</th>
                  <th className="border-r border-slate-700 p-2">Information Disclosed</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Financial Reporting Centre (FRC)</td>
                  <td className="border-r border-slate-700 p-2">AML compliance</td>
                  <td className="p-2">Suspicious Activity Reports (SARs), transaction data</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Kenya Revenue Authority (KRA)</td>
                  <td className="border-r border-slate-700 p-2">Tax compliance</td>
                  <td className="p-2">Withdrawal records, trading income</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Directorate of Criminal Investigations (DCI)</td>
                  <td className="border-r border-slate-700 p-2">Criminal investigations</td>
                  <td className="p-2">Account data, transaction history</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Office of the Data Protection Commissioner (ODPC)</td>
                  <td className="border-r border-slate-700 p-2">Data protection</td>
                  <td className="p-2">Data breach notifications, compliance information</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Capital Markets Authority (CMA)</td>
                  <td className="border-r border-slate-700 p-2">Financial services</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">7.2 International Authorities</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">7.3 Procedures for Government Requests</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">8. DISCLOSURE IN LEGAL PROCEEDINGS</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">8.1 Court Orders and Subpoenas</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">8.2 Civil Litigation</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">8.3 Arbitration</h3>
          <p>In arbitration proceedings, we may disclose information as required by arbitration rules or ordered by the arbitrator.</p>

          <h2 className="font-display text-2xl font-bold text-white mt-8">9. DISCLOSURE TO THIRD-PARTY SERVICE PROVIDERS</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">9.1 Criteria for Third-Party Disclosure</h3>
          <p>Before disclosing information to a third-party service provider, we ensure that:</p>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Legitimate need</td>
                  <td className="p-2">Provider needs the information to perform their service</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Contractual safeguards</td>
                  <td className="p-2">Written agreement includes data protection obligations</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Security standards</td>
                  <td className="p-2">Provider meets minimum security requirements</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Data minimisation</td>
                  <td className="p-2">Only necessary information is shared</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Retention limits</td>
                  <td className="p-2">Provider must delete information after purpose is fulfilled</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Sub-processing control</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">9.2 Current Third-Party Providers</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <thead>
                <tr className="bg-slate-800">
                  <th className="border-r border-slate-700 p-2">Provider</th>
                  <th className="border-r border-slate-700 p-2">Information Disclosed</th>
                  <th className="border-r border-slate-700 p-2">Purpose</th>
                  <th className="border-r border-slate-700 p-2">Data Location</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">SasaPay</td>
                  <td className="border-r border-slate-700 p-2">Phone number, amount, transaction reference</td>
                  <td className="border-r border-slate-700 p-2">M-PESA payments</td>
                  <td className="p-2">Kenya</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Plisio</td>
                  <td className="border-r border-slate-700 p-2">Crypto wallet address, amount, transaction hash</td>
                  <td className="border-r border-slate-700 p-2">Crypto payments</td>
                  <td className="p-2">EU</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Sumsub</td>
                  <td className="border-r border-slate-700 p-2">ID documents, selfies, proof of address</td>
                  <td className="border-r border-slate-700 p-2">KYC verification</td>
                  <td className="p-2">EU</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Amazon Web Services (AWS)</td>
                  <td className="border-r border-slate-700 p-2">All platform data</td>
                  <td className="border-r border-slate-700 p-2">Cloud hosting</td>
                  <td className="p-2">Kenya, Ireland, USA</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">DigitalOcean</td>
                  <td className="border-r border-slate-700 p-2">Backups</td>
                  <td className="border-r border-slate-700 p-2">Data backups</td>
                  <td className="p-2">USA</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2">Google Analytics</td>
                  <td className="border-r border-slate-700 p-2">Anonymous usage data</td>
                  <td className="border-r border-slate-700 p-2">Analytics</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">9.3 Sub-Processors</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">10. DISCLOSURE WITH USER CONSENT</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">10.1 Obtaining Consent</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">10.2 Withdrawal of Consent</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">10.3 Examples of Consent-Based Disclosure</h3>
          <div className="overflow-x-auto mt-3">
            <table className="w-full text-left text-sm border-collapse border border-slate-700">
              <thead>
                <tr className="bg-slate-800">
                  <th className="border-r border-slate-700 p-2">Disclosure</th>
                  <th className="border-r border-slate-700 p-2">Consent Required?</th>
                  <th className="border-r border-slate-700 p-2">How Consent is Obtained</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Marketing emails</td>
                  <td className="border-r border-slate-700 p-2">Yes</td>
                  <td className="p-2">Opt-in checkbox</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Social trading (share trading activity)</td>
                  <td className="border-r border-slate-700 p-2">Yes</td>
                  <td className="p-2">Opt-in toggle</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2">Referral program participation</td>
                  <td className="border-r border-slate-700 p-2">Yes</td>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">11. PUBLIC INFORMATION</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">11.1 Information Intentionally Made Public</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">11.2 User-Generated Public Content</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">12. ANONYMISED AND AGGREGATED DATA</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">12.1 Anonymisation Process</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">12.2 Aggregated Data</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">13. USER ACCESS TO THEIR OWN INFORMATION</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">13.1 Right to Access</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">13.2 How to Request Access</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">13.3 Limitations on Access</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">14. USER RIGHTS REGARDING INFORMATION DISCLOSURE</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">14.1 Right to be Informed</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">14.2 Right to Rectification</h3>
          <p>Users have the right to correct inaccurate or incomplete information.</p>

          <h3 className="font-display text-xl font-bold text-white mt-6">14.3 Right to Erasure (Right to be Forgotten)</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">14.4 Right to Restrict Processing</h3>
          <p>Users may request that we limit how we use their information while disputes are resolved.</p>

          <h3 className="font-display text-xl font-bold text-white mt-6">14.5 Right to Data Portability</h3>
          <p>Users may request a copy of their information in a machine-readable format (JSON, CSV).</p>

          <h3 className="font-display text-xl font-bold text-white mt-6">14.6 Right to Object</h3>
          <p>Users may object to certain types of processing, including marketing and non-essential analytics.</p>

          <h3 className="font-display text-xl font-bold text-white mt-6">14.7 How to Exercise Rights</h3>
          <p>Contact <strong>privacy@initoption.com</strong>. We will respond within 30 days.</p>

          <h2 className="font-display text-2xl font-bold text-white mt-8">15. EMPLOYEE AND CONTRACTOR CONFIDENTIALITY OBLIGATIONS</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">15.1 Confidentiality Agreements</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">15.2 Access Controls</h3>
          ...
          <div className="overflow-x-auto mt-3">
            <table className="w-full text-left text-sm border-collapse border border-slate-700">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Customer support</td>
                  <td className="p-2">Basic user information, support tickets, transaction history</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Compliance team</td>
                  <td className="p-2">Full KYC/AML data, transaction monitoring</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Finance team</td>
                  <td className="p-2">Payment and withdrawal data</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Developers</td>
                  <td className="p-2">Technical data (no personally identifiable information in development environments)</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Senior management</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">15.3 Prohibited Conduct</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">15.4 Training</h3>
          <p>All employees receive annual training on information disclosure and confidentiality obligations.</p>

          <h2 className="font-display text-2xl font-bold text-white mt-8">16. DATA BREACH NOTIFICATION</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">16.1 Definition of Data Breach</h3>
          <p>A data breach is any unauthorised access, acquisition, disclosure, modification, or destruction of personal information.</p>

          <h3 className="font-display text-xl font-bold text-white mt-6">16.2 Internal Reporting</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">16.3 Notification to Authorities</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">16.4 Notification to Affected Users</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">17. CROSS-BORDER DATA TRANSFERS</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">17.1 Countries Where Data May Be Transferred</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">17.2 Safeguards for Cross-Border Transfers</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">17.3 Data Localisation Requirements</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">18. INFORMATION SECURITY MEASURES</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">18.1 Technical Measures</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Encryption in transit</td>
                  <td className="p-2">TLS 1.3 for all data transmission</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Encryption at rest</td>
                  <td className="p-2">AES-256 for stored sensitive data</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Access controls</td>
                  <td className="p-2">Role-based access, multi-factor authentication</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Audit logging</td>
                  <td className="p-2">All access to user information is logged</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Network security</td>
                  <td className="p-2">Firewalls, intrusion detection, DDoS protection</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Backup and recovery</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">18.2 Organisational Measures</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Security policies</td>
                  <td className="p-2">Written policies governing information handling</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Employee training</td>
                  <td className="p-2">Annual security and privacy training</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Vendor management</td>
                  <td className="p-2">Security assessments of third-party providers</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Incident response</td>
                  <td className="p-2">Documented breach response plan</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Regular audits</td>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">19. PROHIBITED DISCLOSURES</h2>
          <p>The following disclosures are strictly prohibited:</p>
          <div className="overflow-x-auto mt-3">
            <table className="w-full text-left text-sm border-collapse border border-slate-700">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Selling user information to third parties</td>
                  <td className="p-2">Immediate termination, legal action</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Sharing information for marketing without consent</td>
                  <td className="p-2">Disciplinary action, regulatory fine</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Unauthorised access out of curiosity</td>
                  <td className="p-2">Disciplinary action, up to termination</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Discussing user information in public</td>
                  <td className="p-2">Disciplinary action</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Taking information offsite without approval</td>
                  <td className="p-2">Disciplinary action</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Disclosing information to unauthorised third parties</td>
                  <td className="p-2">Immediate termination, legal action</td>
                </tr>
              </tbody>
            </table>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">20. CONSEQUENCES OF UNAUTHORISED DISCLOSURE</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">20.1 For Employees and Contractors</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse border border-slate-700 mt-3">
              <tbody>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">First violation (negligent)</td>
                  <td className="p-2">Written warning, retraining</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Second violation (negligent)</td>
                  <td className="p-2">Suspension without pay</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Intentional unauthorised disclosure</td>
                  <td className="p-2">Immediate termination</td>
                </tr>
                <tr className="border-b border-slate-700">
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Disclosure for personal gain</td>
                  <td className="p-2">Termination, legal action, criminal prosecution</td>
                </tr>
                <tr>
                  <td className="border-r border-slate-700 p-2 font-semibold text-white">Disclosure causing user harm</td>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">20.2 For the Company</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">20.3 For Users</h3>
          <p>Users who knowingly cause unauthorised disclosure (e.g., sharing login credentials) may have their accounts terminated.</p>

          <h2 className="font-display text-2xl font-bold text-white mt-8">21. REPORTING VIOLATIONS</h2>
          <h3 className="font-display text-xl font-bold text-white mt-6">21.1 Internal Reporting</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">21.2 External Reporting</h3>
          ...
          <h3 className="font-display text-xl font-bold text-white mt-6">21.3 Whistleblower Protection</h3>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">22. POLICY UPDATES</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-white mt-8">23. CONTACT INFORMATION</h2>
