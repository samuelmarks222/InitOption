...
export const roleAllowsAdminPath = (role: AppRole | null, pathname: string) => {
  ...
  switch (role) {
    ...
    case "finance_manager":
      return ["/admin/finance", "/admin/reports", "/admin/analytics"].some((path) => pathname.startsWith(path));
    ...
    case "content_marketing_manager":
      return ["/admin/promos", "/admin/notifications", "/admin/settings", "/admin/reports"].some((path) =>
