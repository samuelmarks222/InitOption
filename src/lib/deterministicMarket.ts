...
const CATEGORY_PROFILES: Record<AssetCategory, MarketProfile> = {
  OTC: {
    driftAmplitude: 0.008,
    driftScaleSeconds: 8 * 60 * 60,
    swingAmplitude: 0.005,
    swingScaleSeconds: 1.5 * 60 * 60,
    pulseAmplitude: 0.0015,
    pulseScaleSeconds: 5 * 60,
    microAmplitude: 0.0001,
    microScaleSeconds: 20,
    cycleAmplitude: 0.004,
    cycleSeconds: 3 * 60 * 60,
    secondaryCycleAmplitude: 0.002,
    secondaryCycleSeconds: 30 * 60,
    tickAmplitude: 0.00006,
    tickScaleSeconds: 0.8,
    volumeBase: 320,
  },
  CRYPTO: {
