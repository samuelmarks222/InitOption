...
const CATEGORY_PROFILES: Record<AssetCategory, MarketProfile> = {
  OTC: {
    driftAmplitude: 0.0024,
    driftScaleSeconds: 18 * 60 * 60,
    swingAmplitude: 0.0011,
    swingScaleSeconds: 3 * 60 * 60,
    pulseAmplitude: 0.00055,
    pulseScaleSeconds: 8 * 60,
    microAmplitude: 0.0002,
    microScaleSeconds: 28,
    cycleAmplitude: 0.0008,
    cycleSeconds: 6 * 60 * 60,
    secondaryCycleAmplitude: 0.0004,
    secondaryCycleSeconds: 75 * 60,
    tickAmplitude: 0.00013,
  ...
  CRYPTO: {
    ...
    swingAmplitude: 0.014,
    swingScaleSeconds: 4 * 60 * 60,
    pulseAmplitude: 0.0066,
    pulseScaleSeconds: 12 * 60,
    microAmplitude: 0.0027,
    microScaleSeconds: 24,
    cycleAmplitude: 0.0084,
    cycleSeconds: 8 * 60 * 60,
    secondaryCycleAmplitude: 0.0042,
    secondaryCycleSeconds: 90 * 60,
    tickAmplitude: 0.0013,
    tickScaleSeconds: 1.3,
    volumeBase: 720,
  },
  STOCKS: {
    driftAmplitude: 0.013,
    driftScaleSeconds: 24 * 60 * 60,
    swingAmplitude: 0.0054,
    swingScaleSeconds: 5 * 60 * 60,
    pulseAmplitude: 0.0021,
    pulseScaleSeconds: 15 * 60,
    microAmplitude: 0.001,
    microScaleSeconds: 32,
    cycleAmplitude: 0.0039,
    cycleSeconds: 7 * 60 * 60,
    secondaryCycleAmplitude: 0.0018,
  ...
  COMMODITIES: {
    ...
    swingAmplitude: 0.0036,
    swingScaleSeconds: 4 * 60 * 60,
    pulseAmplitude: 0.0015,
    pulseScaleSeconds: 12 * 60,
    microAmplitude: 0.0007,
    microScaleSeconds: 30,
    cycleAmplitude: 0.0025,
    cycleSeconds: 6 * 60 * 60,
    secondaryCycleAmplitude: 0.0013,
    secondaryCycleSeconds: 90 * 60,
