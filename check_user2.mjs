...
const { Pool } = pg;
const pool = new Pool({ 
  connectionString: "postgresql://neondb_owner:npg_vw2Ec9PCKqfQ@ep-wandering-glitter-ayusunjs-pooler.c-5.us-east-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require", 
